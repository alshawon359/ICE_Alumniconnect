...
function AlumniLogin() {
  ...
  const goToDashboard = (alumni) => {
    try {
      sessionStorage.setItem('alumni-dashboard-active-view', 'dashboard')
      sessionStorage.setItem('alumni-force-dashboard-once', '1')
    } catch (_) {}
    navigate('/alumni-dashboard', { replace: true, state: { alumni, activeView: 'dashboard', fromLogin: true } })
  }
          ...
          <Row className="justify-content-center">
            <Col xs={12} sm={10} md={7} lg={5}>
              <div className="login-card">
                <h2><i className="fa-solid fa-user-graduate me-2"></i>Alumni Login</h2>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <div className="forgot-password-row text-start mb-2">
                    <Link to="/alumni-forgot-password" className="forgot-password-link">Forgot password?</Link>
                  </div>
                ...
                <p className="register-text mt-3">
                  Don't have an account? <Link to="/alumni-register">Register here</Link>
                </p>
