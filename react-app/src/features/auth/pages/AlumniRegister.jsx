...
function AlumniRegister() {
  ...
  const [fields, setFields] = useState({
    ...
    student_id: '', session: '', graduation_year: '', hall_name: '',
                ...
                {!submitted ? (
                  <Form onSubmit={handleRegisterClick} ref={formRef} noValidate>
                    <Row>
                      ...
                      <Col xs={12}>
                        <Form.Group className="mb-3 text-start">
                          <Form.Label>Hall / Residential College</Form.Label>
                          <Form.Control type="text" name="hall_name" placeholder="e.g., Shahid Hall, Zia Hall" value={fields.hall_name} onChange={handleChange} />
                        </Form.Group>
                      </Col>
                      <Col xs={12}>
                        <Form.Group className="mb-3 text-start">
        ...
        <Modal.Body style={{ background: 'linear-gradient(135deg,#5f2c82,#a4508b)', color: '#fff', padding: '20px 28px' }}>
          ...
          <Row>
            <Col md={8}>
              ...
              <InfoRow label="Hall / College" value={fields.hall_name} />
