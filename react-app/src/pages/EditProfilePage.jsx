      ...
      <main className="profile-page__shell">
        <header className="profile-hero profile-hero--edit">
          ...
          <div className="profile-hero__body profile-hero__body--edit">
            <div className="profile-hero__identity">
              <button type="button" className="profile-back-btn" onClick={() => { try { goBack() } catch (err) { navigate(-1) } }}>
        ...
        <form className="profile-edit-form" onSubmit={handleSubmit}>
          ...
          <section className="profile-edit-grid">
            <ProfileSectionCard title="Basic Details" eyebrow="Identity">
              <div className="profile-form-grid">
                ...
                <div className="profile-form-field profile-form-grid__full">
                  <label>Hall</label>
                  <input type="text" name="hall_name" value={form.hall_name} onChange={handleChange} placeholder="e.g., Tajhat Hall, Kotowali Hall" />
                </div>
              </div>
            </ProfileSectionCard>
          </section>
          ...
          <div className="profile-page__footer profile-page__footer--edit">
            <button type="button" className="profile-secondary-btn" onClick={() => { try { goBack() } catch (err) { navigate(-1) } }}>Cancel</button>
