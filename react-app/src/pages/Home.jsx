        ...
        <Container fluid="xl">
          <Row className="align-items-center">
            <Col lg={6} className="hero-left">
              <span className="hero-badge">Reconnect with your Alumni Network in one place.</span>
        ...
        <Container>
          <div className="contact-card">
            <div className="contact-copy">
              <span>CONTACT</span>
              <h2>Need help with AlumniConnect?</h2>
              <p>Reach out for portal access, account support, or collaboration inquiries. We keep the process simple and fast for students, alumni, and administrators.</p>
            </div>
            <a className="contact-action" href="mailto:iceaa.ru.2000@gmail.com">
