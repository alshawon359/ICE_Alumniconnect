...
export function ProfessionalEventCard({ event, onRegisterClick, onDetailsClick, themeColor = '#00a3a3' }) {
  ...
  const attachmentIsPdf = attachmentHref.toLowerCase().endsWith('.pdf')
    ...
    <div className="event-card-pro">
      ...
      <div className="event-card-pro-body">
        ...
        <div className="event-card-pro-details">
          ...
          {attachmentHref && (
            <div className="event-card-pro-details-item" style={{ alignItems: 'center' }}>
              <i className="fa-solid fa-paperclip"></i>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                {attachmentIsPdf ? (
                  <i className="fa-solid fa-file-pdf" style={{ color: '#c41d38' }}></i>
                ) : (
                  <i className="fa-regular fa-image" style={{ color: themeColor }}></i>
                )}
                <a href={attachmentHref} target="_blank" rel="noreferrer" style={{ color: themeColor, textDecoration: 'none', fontWeight: 600 }}>
                  {attachmentIsPdf ? 'Open attachment' : 'View attachment'}
                </a>
              </span>
            </div>
          )}
        ...
        <div className="event-card-pro-actions">
          ...
          {(event.attachment || event.attachment_url) && (
            <button className="event-card-pro-btn event-card-pro-btn-doc" onClick={() => onDetailsClick && onDetailsClick()}>
              <i className="fa-solid fa-paperclip"></i> View Doc
            </button>
          )}
        </div>
      </div>
